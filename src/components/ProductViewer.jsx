...
function ProductViewer() {
  ...
  return (
    ...
    <section id="product-viewer" className="relative w-full h-[85vh] bg-black text-white flex flex-col justify-between p-6 overflow-hidden select-none">
          ...
          <div className="flex items-center gap-3 bg-zinc-900/80 border border-zinc-800 backdrop-blur-md px-4 py-2.5 rounded-full">
            <button 
              ...
              className={clsx(
                ...
                color === "#adb5bd" ? 'ring-2 ring-white scale-105' : 'opacity-50 hover:opacity-100'
              )}
            ...
            <button 
              ...
              className={clsx(
                ...
                color === "#2e2c2e" ? 'ring-2 ring-white scale-105' : 'opacity-50 hover:opacity-100'
              )}
          ...
          <div className="flex items-center bg-zinc-900/80 border border-zinc-800 backdrop-blur-md p-1 rounded-full">
            <button 
              className={clsx(
                ...
                scale === 0.06 ? "bg-white text-black font-semibold" : "bg-transparent text-zinc-400 hover:text-white"
              )} 
            ...
            <button 
              className={clsx(
                "px-4 py-1.5 rounded-full text-xs font-medium transition-all duration-200",
                scale === 0.08 ? "bg-white text-black font-semibold" : "bg-transparent text-zinc-400 hover:text-white"
              )} 
